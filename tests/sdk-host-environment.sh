...
pinpoint_configure_sdk_host_environment ()
{
  ...
  export LD_LIBRARY_PATH="$pinpoint_gl_ld_path:$pinpoint_sdk_libdir:$pinpoint_sdk_libdir/pulseaudio${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}"
  ...
  export GST_PLUGIN_SYSTEM_PATH_1_0="$pinpoint_sdk_libdir/gstreamer-1.0"
}
